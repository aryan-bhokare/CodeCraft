    ...
    <div className="flex flex-col justify-center items-center mb-20">
      <div className="flex flex-col items-center justify-center space-y-4">
        <h2 className="text-5xl text-white">
          Interviews made easy by{" "}
          <span className="bg-clip-text text-transparent font-semibold bg-gradient-to-r from-green-400 to-teal-400">
            CodeCraft
          </span>
        </h2>
        <p
        ...
        >
          Dream of seamless coding collaboration? CodeCraft combines dynamic coding capabilities with real-time communication. Code and connect effortlessly in one powerful space. Join now!

        </p>
        <div className="flex space-x-10">
          <button className="p-[3px] relative ">
            <div className="absolute inset-0 bg-gradient-to-r from-green-400 to-teal-400 rounded-lg" />
            <div
          ...
          <div className="flex gap-x-3">
            <input
              ...
              className={`px-4 py-2 rounded-md text-white bg-black border border-gray-400 ${inputError ? "border-red-500" : ""
                }`}
              onChange={(e) => {
